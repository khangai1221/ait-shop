...
import { g as getOrdersByEmail } from "./orders-amTI5j5M.mjs";
import { b as Route$j } from "./router-o9ajxtaq.mjs";
...
function Profile() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center gap-3 sm:gap-4 mb-8 sm:mb-10", children: [
      user.imageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: user.imageUrl, alt: "", className: "h-12 w-12 sm:h-16 sm:w-16 rounded-full object-cover shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 sm:h-16 sm:w-16 rounded-full bg-gradient-to-br from-brand to-brand-deep grid place-items-center text-white font-display text-xl sm:text-2xl shrink-0", children: initial }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-3xl truncate", children: user.fullName ?? user.firstName ?? t("profile.myAccount") }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[240px_1fr] gap-6 lg:gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex lg:flex-col gap-1 overflow-x-auto pb-1 lg:pb-0 scrollbar-hide", children: TABS.map(({
        id,
        label,
        Icon
      }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setTab(id), className: `shrink-0 lg:w-full flex items-center gap-2 lg:gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl text-xs sm:text-sm font-medium transition whitespace-nowrap ${tab === id ? "bg-brand/10 text-brand" : "hover:bg-muted text-muted-foreground"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4 shrink-0" }),
        " ",
        label
      ] }, id)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border p-4 sm:p-8 bg-card", children: [
