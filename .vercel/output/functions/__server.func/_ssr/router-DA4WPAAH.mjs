...
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-CNKxx3CJ.mjs";
...
const KEY = "pk_live_Y2xlcmsuYWl0c2hvcC5tbiQ";
...
const setUserAdmin = createServerFn({
  ...
  userId: numberType(),
  isAdmin: booleanType()
})).handler(createSsrRpc("e7e9223ec49662523b8553cd61113cc2a911739b979627a8eb4fae2e0240b7f1"));
...
function UserSync() {
  ...
  const syncedFor = reactExports.useRef(null);
  reactExports.useEffect(() => {
    if (!isLoaded || !isSignedIn || !user) return;
    if (syncedFor.current === user.id) return;
    syncedFor.current = user.id;
    getOrCreateUser({ data: { displayName: user.fullName ?? void 0 } }).catch(() => {
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SafeClerkProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(UserSync, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StoreProvider, { children: [
...
const $$splitComponentImporter$r = () => import("./wishlist-D9Lp_6yr.mjs");
const Route$r = createFileRoute("/wishlist")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$q = () => import("./sustainability-CS9HgmAH.mjs");
const Route$q = createFileRoute("/sustainability")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$p = () => import("./shop-u4gb8dGA.mjs");
const Route$p = createFileRoute("/shop")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$o = () => import("./shipping-BOCoPsr5.mjs");
const Route$o = createFileRoute("/shipping")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$n = () => import("./search-BDds0GTf.mjs");
const Route$n = createFileRoute("/search")({
...
const $$splitComponentImporter$m = () => import("./sale-0DGHouGE.mjs");
const Route$m = createFileRoute("/sale")({
  head: () => ({
    meta: [{
      title: "Sale — AIT Shop"
    }]
...
const $$splitComponentImporter$l = () => import("./returns-BRMtXuut.mjs");
const Route$l = createFileRoute("/returns")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$k = () => import("./profile-B25CooAo.mjs");
const Route$k = createFileRoute("/profile")({
  validateSearch: objectType({
...
const $$splitComponentImporter$j = () => import("./payment-options-DBH5zqSX.mjs");
const Route$j = createFileRoute("/payment-options")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$i = () => import("./order-success-DKoUswSC.mjs");
...
const $$splitComponentImporter$h = () => import("./newsletter-5Vz83Pn3.mjs");
const Route$h = createFileRoute("/newsletter")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$g = () => import("./news-CZlVhNOY.mjs");
...
const $$splitComponentImporter$f = () => import("./new-arrivals-i-Yz19Js.mjs");
const Route$f = createFileRoute("/new-arrivals")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$e = () => import("./login-DpRO6cWg.mjs");
...
const $$splitComponentImporter$d = () => import("./investors-zladr3_T.mjs");
const Route$d = createFileRoute("/investors")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$c = () => import("./find-store-MgFloNee.mjs");
const Route$c = createFileRoute("/find-store")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$b = () => import("./feedback-AbhzHsD0.mjs");
const Route$b = createFileRoute("/feedback")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$a = () => import("./contact-D2FZ6pNW.mjs");
...
const $$splitComponentImporter$9 = () => import("./checkout-DXlEK20t.mjs");
...
const $$splitComponentImporter$8 = () => import("./categories-D6_sLepW.mjs");
const Route$8 = createFileRoute("/categories")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./cart-CODVudqL.mjs");
...
const $$splitComponentImporter$6 = () => import("./careers-tFDSlRQn.mjs");
...
const $$splitComponentImporter$5 = () => import("./admin-CV2e2CCI.mjs");
...
const $$splitComponentImporter$4 = () => import("./about-CrsDByak.mjs");
...
const $$splitComponentImporter$3 = () => import("./index-CLs3M3aA.mjs");
...
const $$splitComponentImporter$2 = () => import("./product._id-Dvdm9iNC.mjs");
const Route$2 = createFileRoute("/product/$id")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./login._-3Bq8mF8f.mjs");
...
const $$splitComponentImporter = () => import("./category._slug-B8ZlbkAr.mjs");
const Route = createFileRoute("/category/$slug")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const WishlistRoute = Route$r.update({
  id: "/wishlist",
  path: "/wishlist",
  getParentRoute: () => Route$s
});
const SustainabilityRoute = Route$q.update({
  id: "/sustainability",
  path: "/sustainability",
  getParentRoute: () => Route$s
});
...
const ShippingRoute = Route$o.update({
  id: "/shipping",
  path: "/shipping",
  getParentRoute: () => Route$s
});
const SearchRoute = Route$n.update({
  id: "/search",
  path: "/search",
  getParentRoute: () => Route$s
});
const SaleRoute = Route$m.update({
  id: "/sale",
  path: "/sale",
  getParentRoute: () => Route$s
});
const ReturnsRoute = Route$l.update({
  id: "/returns",
  path: "/returns",
  getParentRoute: () => Route$s
});
const ProfileRoute = Route$k.update({
  id: "/profile",
  path: "/profile",
  getParentRoute: () => Route$s
});
const PaymentOptionsRoute = Route$j.update({
  id: "/payment-options",
...
const NewsletterRoute = Route$h.update({
  id: "/newsletter",
  path: "/newsletter",
  getParentRoute: () => Route$s
});
...
const NewArrivalsRoute = Route$f.update({
  id: "/new-arrivals",
  path: "/new-arrivals",
  getParentRoute: () => Route$s
});
...
const InvestorsRoute = Route$d.update({
  id: "/investors",
  path: "/investors",
  getParentRoute: () => Route$s
});
const FindStoreRoute = Route$c.update({
  id: "/find-store",
  path: "/find-store",
  getParentRoute: () => Route$s
});
const FeedbackRoute = Route$b.update({
  id: "/feedback",
  path: "/feedback",
  getParentRoute: () => Route$s
});
...
const CategoriesRoute = Route$8.update({
  id: "/categories",
  path: "/categories",
  getParentRoute: () => Route$s
});
...
const LoginSplatRoute = Route$1.update({
  id: "/$",
  path: "/$",
