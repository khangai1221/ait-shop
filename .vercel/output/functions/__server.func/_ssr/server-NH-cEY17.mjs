...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Ban1aHcL.mjs");
...
const manifest = {
  ...
  "2ac40e083cd3006573712a88d250c9be04466be4f2abe3bf0ff4af307c81ea83": {
    ...
    importer: () => import("./import-products-WsdjTb58.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CJ0AhuTC.mjs").then((n) => n.r),
    import("./start-DXoYtcaz.mjs"),
