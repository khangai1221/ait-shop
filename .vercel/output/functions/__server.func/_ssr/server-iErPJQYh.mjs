...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-_zTg5WcF.mjs");
...
const manifest = {
  ...
  "2ac40e083cd3006573712a88d250c9be04466be4f2abe3bf0ff4af307c81ea83": {
    ...
    importer: () => import("./import-products-PTjMFsBn.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-o9ajxtaq.mjs").then((n) => n.r),
    import("./start-D7X4apCN.mjs"),
