...
const appCss = "/assets/styles-W4VUjxKq.css";
...
function StoreProvider({ children }) {
  ...
  const addToCart = (p, size = 42, color = p.colors[0], qty = 1) => {
    setCart((c) => {
  ...
  const updateQty = (id, qty) => setCart((c) => c.map((i) => i.product.id === id ? { ...i, quantity: Math.max(1, qty) } : i));
  ...
  en: {
    translation: {
      ...
      newArrivals: {
        tag: "Just dropped",
        title: "New Arrivals",
        subtitle: "The latest silhouettes from the AirStep design lab. Be the first to step in them."
      },
      contact: {
        title: "Contact",
      ...
      newsletter: {
        ...
        privacyNote: "We'll only email you about AirStep. Unsubscribe anytime."
      },
      feedback: {
        tag: "We're listening",
        title: "Site feedback",
        desc: "Found a bug, or have an idea to make AirStep better? Tell us.",
        label: "Your feedback",
      ...
      paymentPage: {
        ...
        desc: "Two simple ways to pay — choose whichever works best for you.",
        qpayTitle: "QPay",
        qpayDesc: "Scan the QR code at checkout with your QPay app for instant payment.",
        pickupTitle: "Pay at pickup",
        pickupDesc: "Reserve online and pay in person when you collect your order in-store."
      },
      newsPage: {
        tag: "AirStep",
        title: "News",
        desc: "Announcements and updates from AirStep.",
      ...
      investorsPage: {
        tag: "AirStep",
        title: "Investors",
        desc: "AirStep is an independent, founder-run shop. For partnership or investment inquiries, we'd love to hear from you.",
        button: "Get in touch"
      },
      sustainabilityPage: {
        tag: "AirStep",
  ...
  mn: {
    translation: {
      ...
      newsletter: {
        ...
        privacyNote: "Бид зөвхөн AirStep-тэй холбоотой имэйл илгээх болно. Хүссэн үедээ цуцлах боломжтой."
      },
      feedback: {
        tag: "Бид сонсож байна",
        title: "Санал хүсэлт",
        desc: "Алдаа олсон уу, эсвэл AirStep-ийг сайжруулах санаа байна уу? Бидэнд хэлээрэй.",
      ...
      paymentPage: {
        ...
        desc: "Танд тохирох хоёр энгийн төлбөрийн арга.",
        qpayTitle: "QPay",
        qpayDesc: "Захиалга хийхдээ QPay апп-аараа QR кодыг уншуулж шууд төлнө.",
        pickupTitle: "Авахдаа төлөх",
        pickupDesc: "Онлайнаар захиалж, дэлгүүрт ирж авахдаа газар дээр нь төлнө үү."
      },
      newsPage: {
        tag: "AirStep",
        title: "Мэдээ",
        desc: "AirStep-ийн мэдэгдэл, шинэчлэлтүүд.",
      ...
      investorsPage: {
        ...
        desc: "AirStep бол үндсэн байгуулагчдаараа удирддаг бие даасан дэлгүүр юм. Хамтын ажиллагаа, хөрөнгө оруулалтын асуудлаар бидэнтэй холбогдоорой.",
        button: "Холбогдох"
      },
      sustainabilityPage: {
        tag: "AirStep",
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 w-full bg-background/90 backdrop-blur-lg border-b border-border/60", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-16 sm:h-18 items-center justify-between gap-3 sm:gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-9 w-9 items-center justify-center rounded-xl bg-brand text-brand-foreground shadow-lg shadow-brand/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", children: "A" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-ink font-bold hidden sm:inline", children: "AirStep" })
            ]
          }
        ),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 lg:hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/40 animate-fade-in", onClick: close }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ref: menuRef,
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-16 md:mt-24 bg-ink text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 md:py-16 grid gap-8 sm:gap-10 md:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FooterSection, { title: t("common.aboutAirStep"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2.5 text-sm text-white/70 pb-2", children: [
...
const Route$r = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Discover AirStep — modern sneakers for running, basketball, training and everyday style."
      },
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SafeClerkProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(StoreProvider, { children: [
    ...
    isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
...
const $$splitComponentImporter$q = () => import("./wishlist-XhrGHNe1.mjs");
const Route$q = createFileRoute("/wishlist")({
  head: () => ({
    meta: [{
      title: "Wishlist — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("./sustainability-B7Kf-ruK.mjs");
const Route$p = createFileRoute("/sustainability")({
  head: () => ({
    meta: [{
      title: "Sustainability — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("./shop-D59ZShaN.mjs");
const Route$o = createFileRoute("/shop")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Browse the full AirStep collection."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./shipping-C1X7mND1.mjs");
const Route$n = createFileRoute("/shipping")({
  head: () => ({
    meta: [{
      title: "Shipping & Delivery — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("./search-C49e4ZSf.mjs");
const Route$m = createFileRoute("/search")({
  ...
  head: () => ({
    meta: [{
      title: "Search — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./sale-D6_4YZ5s.mjs");
...
const $$splitComponentImporter$k = () => import("./returns-H7MgtrJ1.mjs");
const Route$k = createFileRoute("/returns")({
  head: () => ({
    meta: [{
      title: "Returns — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./profile-B1EfUa6d.mjs");
const Route$j = createFileRoute("/profile")({
  ...
  head: () => ({
    meta: [{
      title: "My account — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./payment-options-CWPPlEqo.mjs");
const Route$i = createFileRoute("/payment-options")({
  head: () => ({
    meta: [{
      title: "Payment options — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./order-success-BtC3OoZ0.mjs");
const Route$h = createFileRoute("/order-success")({
  ...
  head: () => ({
    meta: [{
      title: "Order confirmed — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./newsletter-C0DM0GaN.mjs");
const Route$g = createFileRoute("/newsletter")({
  head: () => ({
    meta: [{
      title: "Newsletter — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./news-Cj7hntNU.mjs");
...
const $$splitComponentImporter$e = () => import("./new-arrivals-BINSUXHI.mjs");
const Route$e = createFileRoute("/new-arrivals")({
  head: () => ({
    meta: [{
      title: "New Arrivals — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./login-CTIt486k.mjs");
const Route$d = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [{
      title: "Sign in — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./investors-DoXfDjRX.mjs");
const Route$c = createFileRoute("/investors")({
  head: () => ({
    meta: [{
      title: "Investors — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./find-store-DsN4BP-M.mjs");
const Route$b = createFileRoute("/find-store")({
  head: () => ({
    meta: [{
      title: "Find a store — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./feedback-PYR1FhXq.mjs");
const Route$a = createFileRoute("/feedback")({
  head: () => ({
    meta: [{
      title: "Site feedback — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./contact-DnEUMonz.mjs");
const Route$9 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      title: "Contact us — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./checkout-BBgzbBjI.mjs");
const Route$8 = createFileRoute("/checkout")({
  head: () => ({
    meta: [{
      title: "Checkout — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./categories-C5uIXj1U.mjs");
const Route$7 = createFileRoute("/categories")({
  head: () => ({
    meta: [{
      title: "Categories — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./cart-DbXqfbe5.mjs");
...
const $$splitComponentImporter$5 = () => import("./careers-BA9tIz5N.mjs");
const Route$5 = createFileRoute("/careers")({
  head: () => ({
    meta: [{
      title: "Careers — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./admin-Dbi5HWNJ.mjs");
const Route$4 = createFileRoute("/admin")({
  head: () => ({
    meta: [{
      title: "Admin Dashboard — AirStep"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./about-FsVWEc4Q.mjs");
...
const $$splitComponentImporter$2 = () => import("./index-CBJCwqj0.mjs");
...
const $$splitComponentImporter$1 = () => import("./product._id-DXVfKsvZ.mjs");
const Route$1 = createFileRoute("/product/$id")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./category._slug-DVSsGTjW.mjs");
