    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        ...
        children: [
          ...
          outOfStock && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-3 left-3 z-10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider rounded-full bg-red-500 text-white", children: t("common.outOfStock") }),
