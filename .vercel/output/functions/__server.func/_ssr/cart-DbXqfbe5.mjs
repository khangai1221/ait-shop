...
import { a as ShoppingBag, o as ChevronLeft, q as Minus, r as Plus, b as Trash2 } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[1fr_380px] gap-6 lg:gap-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 sm:mt-4 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center border border-border rounded-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => updateQty(item.product.id, item.quantity - 1), className: "h-8 sm:h-9 w-8 sm:w-9 grid place-items-center active:scale-90 hover:bg-muted rounded-full transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-3 sm:h-3.5 w-3 sm:w-3.5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 sm:px-3 text-xs sm:text-sm font-semibold", children: item.quantity }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => updateQty(item.product.id, item.quantity + 1), className: "h-8 sm:h-9 w-8 sm:w-9 grid place-items-center active:scale-90 hover:bg-muted rounded-full transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-3 sm:h-3.5 w-3 sm:w-3.5" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => removeFromCart(item.product.id), className: "text-muted-foreground hover:text-destructive p-1.5 sm:p-2 active:scale-90 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-3.5 sm:h-4 w-3.5 sm:w-4" }) })
          ] })
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "h-fit rounded-2xl border border-border p-5 sm:p-6 bg-card sm:sticky sm:top-24", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/checkout", className: "mt-4 sm:mt-6 block text-center h-11 sm:h-12 leading-[2.75rem] sm:leading-[3rem] rounded-full bg-brand text-brand-foreground font-semibold hover:bg-brand-deep transition active:scale-[0.98]", children: t("cart.checkout") }),
